...
class Student:
    def __init__(self,root):
        ...
        ##Background image
        img3=Image.open(r"C:\Users\ACER\Desktop\Facialrecognitionsystem\Face-recognition\img\download.jpg")
        ...
        right_frame.place(x=665,y=10,width=600,height=580)
        ...
        self.student_table=ttk.Treeview(table_frame,column=("Student_ID","Name","Contact","Email","Address"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.student_table.column("Student_ID",width=65)
    ...
    def add_data(self):
        if self.std_id.get()=="" or self.std_name.get()=="" or self.std_contact.get()=="" or self.std_email.get()=="" or self.std_address.get()=="":
...
#===============get cursor============
    ...
    def get_cursor(self,event=""):
        ...
        self.std_name.set(data[1]),
        self.std_contact.set(data[2]),
        self.std_email.set(data[3]),
        self.std_address.set(data[4]),
        ...
        if self.std_id.get()=="" or self.std_name.get()=="" or self.std_contact.get()=="" or self.std_email.get()=="" or self.std_address.get()=="":
            ...
            try:
                ...
                if update>0:
                    conn = mysql.connector.connect(host="localhost",user="root",password="",database="student_db")
                    my_cursor = conn.cursor()
                    sql="update student set std_name=%s,std_contact=%s,std_email=%s,std_address=%s where std_id=%s"
    ...
    def generate_dataset(self):
        ...
        if self.std_id.get()=="" or self.std_name.get()=="" or self.std_contact.get()=="" or self.std_email.get()=="" or self.std_address.get()=="":
            ...
            try:
                ...
                #id = len(myresult) + 1  # Incrementing ID based on existing records
                id = 0  # Initialize image ID for each student
                for _ in myresult:
                    id+=1
                sql="update student set std_name=%s,std_contact=%s,std_email=%s,std_address=%s where std_id=%s"
                my_cursor.execute(sql,(
                ...
                face_classifier = cv2.CascadeClassifier("C:/Users/ACER/Desktop/Facialrecognitionsystem/Face-recognition/haarcascade_frontalface_default.xml")
                ...
                while True:
                    ...
                    if face_cropped(my_frame) is not None:
                        ...
                        file_name_path=r"C:/Users/ACER/Desktop/Facialrecognitionsystem/Face-recognition/data/user."+str(id)+"."+str(img_id)+".jpg"
